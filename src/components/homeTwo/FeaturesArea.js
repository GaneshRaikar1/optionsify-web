               ...
               <div className="row">
                  <div className="col-xxl-11 offset-xxl-1">
                     <div className="section__title-wrapper mb-65">
                        <p className="section__title">Optionsify platform is packed with features designed to make your trading experience as easy and efficient as possible. With our proprietary options trader, you can execute, monitor, and seamlessly trade. Whether you're a seasoned trader or just starting out, we've got you covered.</p>
                     </div>
                  </div>
               </div>
               <div className="row">
