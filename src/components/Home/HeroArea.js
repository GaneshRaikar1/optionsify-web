...
const HeroArea = () => {
                  ...
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-8 col-sm-8">
                     <div className="hero__content">
                        ...
                        <h2>
                           ...
                           {/* Effortlessly execute customized algorithms for Nifty and Banknifty, Futures, and Options, with complete automation and flexibility. */}
  ...
  <img className="layer" data-depth="0.3" src="assets/img/hero/hero-2.png" alt="" width="350" height="auto" />
</div> */}
                        <div className="hero__thumb three d-none d-md-block">
                           <img className="layer" data-depth="0.4" src="assets/img/hero/hero-3.png" alt="" width="450" height="auto" />
                        </div>
