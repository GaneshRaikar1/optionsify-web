...
import { faqsA, faqsB, faqsC, faqsD } from '../../data/faqTradeBots';
                     ...
                     <div className="faq__tab wow fadeInLeft" data-wow-delay=".3s">
                        <ul className="nav nav-tabs" id="faqTab" role="tablist">
                           <li className="nav-item" role="presentation">
                              <button className="nav-link active" id="sale-tab" data-bs-toggle="tab" data-bs-target="#sale" type="button" role="tab" aria-controls="sale" aria-selected="false">Sales</button>
                           </li>
                           <li className="nav-item" role="presentation">
